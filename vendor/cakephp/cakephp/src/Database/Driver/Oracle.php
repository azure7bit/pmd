...
class Oracle extends Driver
{
    ...
    public function connect()
    {
        ...
        $config['init'][] = "ALTER SESSION SET NLS_DATE_FORMAT='MM/DD/YYYY HH24:MI:SS' NLS_TIMESTAMP_FORMAT='MM/DD/YYYY HH24:MI:SS' NLS_TIMESTAMP_TZ_FORMAT='YYYY-MM-DD HH24:MI:SS'";

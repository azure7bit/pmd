...
class CreateVacancies extends AbstractMigration
{
    ...
    public function change()
    {
      ...
      $table->addColumn('vacancy_id', 'integer', ['null' => false, 'limit' => 15])
            ->addColumn('vacancy_code', 'string', ['limit' => 50])
            ...
            ->addColumn('people_category_code', 'string', ['limit' => 30])
            ...
            ->addColumn('process_version_id', 'integer', ['limit'=>15])

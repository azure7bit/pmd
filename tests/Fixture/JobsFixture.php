...
class JobsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'job_name' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'job_id' => ['type' => 'unique', 'columns' => ['job_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created_by' => 1,
            'creation_date' => 1448877023,
            'last_updated_by' => 1,
            'last_update_date' => 1448877023
        ],
    ];
}
